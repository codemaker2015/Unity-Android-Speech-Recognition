...
public class SpeechToTextController : MonoBehaviour {
    ...
    public void SpeakOnClick() {
        ...
        // The speech recognizer intent will return the string result to onActivityResult method of "SpeechToTextController"
        pluginClass.CallStatic("setReturnObject", "SpeechToTextController");
